...
// 1. Compute the covariance matrix of each Gaussian on world space
// 2. Take length of the scale vector's longest axis as the radius
{
	...
	// Transfer covariance matrix to voxel space
	...
	// Take length of the covariance matrix's longest axis as the radius
